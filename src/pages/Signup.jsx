                ...
                <div className="p-5 lg:p-6 grow w-full">
                  <div className="sm:p-5 lg:px-10 lg:py-8">
                    <form className="space-y-6" onSubmit={formik.handleSubmit}>           
                      ...
                      <div className="space-y-1">
                        <label htmlFor="password" name="password" className="font-medium">Password</label>
                        <input {...formik.getFieldProps('password')} className="block border
                         border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-teal-500 focus:ring
                          focus:ring-teal-500 focus:ring-opacity-50" type="password" id="password" name="password" placeholder="Enter your password" />  
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2 sm:flex sm:items-center sm:justify-between sm:space-x-2 sm:space-y-0 mt-4">
                          <label className="flex items-center">
                            <span className="ml-2">
                                Do you already have an account registered?
                                <Link className="font-medium text-teal-600 hover:text-teal-400" to="/login"> login now</Link>
                            </span>
